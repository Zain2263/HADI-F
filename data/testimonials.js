export const testimonialsData = [
  {
    ...
    review:
      "You are doing a great job. Your courses are premium, and we are so eager to learn from your staff. I am more confident now and thankful to you for this favor. May Allah give you everything you wish for. Ameen",
    img: "/images/testimonials/rida.webp",
  },
  {
    name: "Muneeb Tariq ( Digital Media Marketing)",
    review:
      "This platform is very helpful and knowledgeable. Free courses are a huge plus for this platform at this time. We are really grateful to Hadi e-learning and your team's cooperation",
    img: "/images/testimonials/muneeb.webp",
  },
  {
    name: "Syed Uzair Abbas ( Wordpress Course) ",
    review:
      "Just finished Hadi E-Learning's WordPress course; it's incredibly well-structured. Instructor Sir Hunzala Baloch is knowledgeable and responsive. Already signed up for their Shopify course. Highly recommend Hadi E-Learning for education seekers!",
    img: "/images/testimonials/uzair.webp",
  },
  {
    name: "Zubia Khan (Graphic Designing Course)",
    review:
      "Hadi E-LEARNING's graphic designing course was comprehensive and well-structured. I gained valuable skills and confidence, thanks to the supportive instructors. Ready to take on real-world projects!",
...

  {
    ...
    review:
      "My name is Khudija Yasir, and I successfully completed the VA Amazon course from Hadi Learning under the guidance of Maam Maham Shah. I have also done an internship with them. I am pleased to announce that I am running my Amazon account successfully.",
